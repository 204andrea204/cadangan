  ...
  <!-- Custom fonts for this template-->
        ...
        <style type="text/css">
            .login-page .form-box .univ-identity-box{
                background: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)),url('/login-template/Universitas Trilogi_files/image_3.jpg') bottom;
                background-size:cover;
            }
            html, body{
                background-image: url('/login-template/Universitas Trilogi_files/bg_2.jpg');
                background-size: cover;
            }
            .password{
                position: relative;
            ...
            <div class="row">
                <div class="form-box col-md-8 col-sm-10 col-xs-12">
                    ...
                    <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 form-login" align="center">
                        <img src="/login-template/Universitas Trilogi_files/logo.webp" class="logo"><br>
